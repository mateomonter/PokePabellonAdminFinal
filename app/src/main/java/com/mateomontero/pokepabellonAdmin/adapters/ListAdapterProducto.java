...
public class ListAdapterProducto extends RecyclerView.Adapter<ListAdapterProducto.ViewHolder>{
    ...
    public ListAdapterProducto.OnItemClickListener listener;
    public interface OnItemClickListener {
        void onItemClick(Producto producto);
    }

    public ListAdapterProducto(List<Producto> itemList, Context context, ListAdapterProducto.OnItemClickListener listener) {
